...
router.post('/login', async (req, res) => {
  try {
    ...
    return res.json({ token, user: { id: user._id, name: user.name, email: user.email, phone: user.phone, preferredLanguage: user.preferredLanguage || 'en' } });
  } catch (error) {
...
router.post('/verify-signup-otp', async (req, res) => {
  try {
    ...
    const token = createToken(user);
    return res.json({ token, user: { id: user._id, name: user.name, email: user.email, phone: user.phone, preferredLanguage: user.preferredLanguage } });
  } catch (error) {
