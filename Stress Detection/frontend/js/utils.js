...
export function getStressLabelColor(score) {
  if (score <= 30) return { bg: 'bg-green-100', text: 'text-green-700', border: 'border-green-200' };
  if (score <= 60) return { bg: 'bg-orange-100', text: 'text-orange-700', border: 'border-orange-200' };
  return { bg: 'bg-red-100', text: 'text-red-700', border: 'border-red-200' };
}

export function getStressLabelDot(score) {
  if (score <= 30) return '#22c55e';
  if (score <= 60) return '#f97316';
  return '#ef4444';
}

export function formatStressDate(dateString) {
